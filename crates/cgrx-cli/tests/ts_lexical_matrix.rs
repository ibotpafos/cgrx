...
#[test]
fn frozen_ts_lexical_matrix_preserves_exact_targets_and_rejects_false_edges() {
    let corpus: Value =
        serde_json::from_str(include_str!("../../../contracts/ts_lexical_cases_v1.json")).unwrap();
    let scope = Scope {
        include: vec![],
        exclude: vec![],
