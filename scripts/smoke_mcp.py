...
with tempfile.TemporaryDirectory(prefix="cgrx-smoke-") as directory:
    ...
    assert len(responses[1]["result"]["tools"]) == 17, responses[1]
...
print("MCP_SMOKE=PASS; TOOLS=17; CALLER=caller; BODY_SEARCH=target; OUTLINE=5; USAGES=1; REFACTORS=1; ARCHITECTURE=1")
