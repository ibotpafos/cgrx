...
| Language breadth | ⚠️ 11 packs today (Rust, Go, Java, TS/JS/TSX, Python, C, C++, C#, Ruby, PHP, Kotlin) | ✅ Very broad language support | ✅ Very broad (SCIP/LSIF) | ✅ Larger symbol-only surface documented |
