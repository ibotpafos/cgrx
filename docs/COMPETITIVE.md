...
| Language breadth | ⚠️ 8 packs today (Rust, Go, Java, TS/JS/TSX, Python, C, C++, Kotlin) | ✅ Very broad language support | ✅ Very broad (SCIP/LSIF) | ✅ Larger symbol-only surface documented |
